...
* 🗓 Created : 14/02/2024
*/
const saveContactDetails = (container) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const saveUserData = (container) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const userData = Object.assign(Object.assign({}, user[0]), { street_address: body.street_address, building: body.building ? body.building : null, country_id: body.country_id, state: body.state ? body.state : null, town: body.town ? body.town : null, phone_number: body.phone_number });
...
exports.default = saveContactDetails;
//# sourceMappingURL=saveContact.service.js.map